...
public class TransactionValidator {
    ...
    public TransactionValidator(UserService userService, CurrencyCodeValidator currencyCodeValidator) {
    ...
    /**
     *
     * @param requestData transaction data provided by user
     * throws suitable exception for respective errors
     */
